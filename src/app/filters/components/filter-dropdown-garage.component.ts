...
@Component({
    selector: 'filter-dropdown-garage',
    templateUrl: './__mobile__/filter-dropdown-garage.component.html',
    styleUrls: ['./__mobile__/styles/filter-dropdown-garage.component__.scss']
})

export class FilterDropdownGarageComponent implements OnChanges {
